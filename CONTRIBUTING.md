...
The Linode documentation library is built using [Hugo](http://gohugo.io), an open-source static site generator. In order to preview your guide before submission, you need to install Hugo on your local computer. This site currently uses **Hugo v0.159.0**. To remain consistent in the testing and development process, it's recommended to install this version instead of using a newer version.
...
1.  Download the file below that corresponds with the OS and platform on your local system. If you don't see your system on this list, you can find additional files on the [Hugo v0.159.0 GitHub release page](https://github.com/gohugoio/hugo/releases/tag/v0.159.0) under **Assets**.

    - **macOS:** https://github.com/gohugoio/hugo/releases/download/v0.159.0/hugo_extended_0.159.0_darwin-universal.tar.gz
    - **Linux:** https://github.com/gohugoio/hugo/releases/download/v0.159.0/hugo_extended_0.159.0_Linux-64bit.tar.gz
...
1.  Download the [hugo_extended_0.159.0_windows-amd64.zip](https://github.com/gohugoio/hugo/releases/download/v0.159.0/hugo_extended_0.159.0_windows-amd64.zip) file. Additional files for other operating systems can be found on the [Hugo v0.159.0 GitHub release page](https://github.com/gohugoio/hugo/releases/tag/v0.159.0) under **Assets**.
...
1.  Upgrade Hugo to v0.159.0. On macOS, run the following commands in a temporary folder (not in your docs repo):

        curl -OL https://github.com/gohugoio/hugo/releases/download/v0.159.0/hugo_extended_0.159.0_darwin-universal.tar.gz
        tar -xvzf hugo_extended_0.159.0_darwin-universal.tar.gz
        mv hugo /usr/local/bin
